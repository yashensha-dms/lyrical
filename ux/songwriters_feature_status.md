...
| **Anti-Thesaurus Simplifier** | Emily Warren / Cara DioGuardi | **v2.4.0** | Scans draft contents for complex vocabulary and 4+ syllable words in [RightPanel.tsx](file:///d:/Projects/Songwriting/src/components/RightPanel.tsx) using [simplifier.ts](file:///d:/Projects/Songwriting/src/utils/simplifier.ts). Suggests simpler replacements with click-to-swap. |
| **Conversational Phrase Catcher** | Justin Tranter / Cara DioGuardi | **v2.5.0** | Collapsible bottom drawer in Songs list ([Sidebar.tsx](file:///d:/Projects/Songwriting/src/components/Sidebar.tsx)) to quickly capture overheard dialogue, copy to clipboard, append to scrapbook, or start new songs. |
